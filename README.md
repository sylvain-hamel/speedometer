...
```bash
node tools/verify.mjs       # 77 end-to-end checks + layout screenshots
...
the fix-quality bands and their hysteresis, the status panel, the target colour thresholds
and species list, service-worker precaching, offline boot, and layout across four iPhone
viewports.
